  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-2">Found Items</h1>
          <p className="text-muted-foreground">Browse items that people have found and reported</p>
        </div>
      ...
      <Dialog open={contactDialogOpen} onOpenChange={setContactDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Use this information to contact the person who found this item
            </DialogDescription>
          </DialogHeader>
          {selectedItem && (
